    ...
    public class PropertyMappingService : IPropertyMappingService
    {
        ...
        private Dictionary<string, PropertyMappingValue> _accountsPropertyMapping =
          new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
          {
               ...
               { "FullNames", new PropertyMappingValue(new List<string>() { "Surname", "Othernames" } )},
               { "EmailAddress", new PropertyMappingValue(new List<string>() { "EmailAddress" } , true)},
               { "PhoneNo", new PropertyMappingValue(new List<string>() { "PhoneNo" } ) },
               { "Lpno", new PropertyMappingValue(new List<string>() { "Lpno" }, true ) },
          };
