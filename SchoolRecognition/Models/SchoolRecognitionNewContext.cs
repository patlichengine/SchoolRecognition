...
{
    public partial class SchoolRecognitionNewContext : DbContext
    {
        public SchoolRecognitionNewContext()
        {
        }

        public SchoolRecognitionNewContext(DbContextOptions<SchoolRecognitionNewContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-VDEN9VA;Database=SchoolRecognitionNew;User Id=sa;Password=sa@12345678;");
            }
        }
